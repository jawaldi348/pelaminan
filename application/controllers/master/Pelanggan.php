...
class Pelanggan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->display('master/pelanggan/index', $data);
    }
    ...
    public function create()
    {
        ...
        $this->template->modal_form('master/pelanggan/create', $data);
    }
    ...
    public function edit()
    {
        ...
        $this->template->modal_form('master/pelanggan/edit', $data);
    }
    public function update()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            $post = $this->input->post(null, TRUE);
            $this->Mpelanggan->update($post);
            $json = array(
                'status' => '0100',
                'pesan' => 'Data pelanggan telah dirubah'
            );
        } else {
            $json = array(
                'status' => '0101'
    ...
    public function destroy()
    {
        ...
        $action = $this->Mpelanggan->destroy($kode);
        if ($action) {
            $json = array(
                'status' => '0100',
