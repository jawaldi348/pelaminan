        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var count = 0; count < data.length; count++) {
                    var level = (data[count].level == '1' ? 'Admin' : 'Pimpinan');
                    html += '<tr>';
                    html += '<td class="center" width="40px">' + no + '</td>';
                    html += '<td>' + data[count].username + '</td>';
                    html += '<td>' + level + '</td>';
                    html += '<td class="center" width="100px">';
                    html += '<a class="green" href="javascript:void(0)" onclick="edit(' + data[count].id_user + ')"><i class="ace-icon icon-pencil7 bigger-120"></i></a>';
                    html += '&nbsp;';
                    html += '<a class="red" href="javascript:void(0)" onclick="destroy(' + data[count].id_user + ')"><i class="ace-icon icon-trash bigger-120"></i></a>';
                    html += '</td>';
                    html += '</tr>';
                    no++;
                }
